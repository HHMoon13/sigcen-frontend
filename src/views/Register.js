...
const column = ['Security Classification', "Originator's No", 'Date', 'From', 'To', 'Action']
...
const Register = () => {
  ...
  const fetchMessageList = async () => {
    const response = await TeacherService.instance.getRegister()
    console.log(response)
    if (response.status) setTableData(response.registerData)
  }
